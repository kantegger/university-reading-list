...
difficulty: advanced
level: graduate
description: 'Graduate-level exploration of risk-neutral valuation, pricing, and hedging of financial derivatives, combining rigorous theory with applications in derivatives pricing, interest rate modelling, and risk management.'
...
Explores risk-neutral valuation in discrete-time settings, providing a foundation for understanding how to price derivatives using risk-neutral probabilities.

### Chapter 5: Stochastic Processes in Continuous Time

Introduces Brownian motion and Itô calculus, which are essential for modeling continuous-time financial processes.

### Chapter 6: Mathematical Finance in Continuous Time

Explores the Black-Scholes model for option pricing and its derivation using continuous-time processes.

### Chapter 7: Incomplete Markets

Discusses market completeness and incompleteness, and the implications for derivative pricing.

### Chapter 8: Interest Rate Theory

Analyzes different models of the term structure of interest rates and their applications in pricing interest rate-dependent securities.

### Chapter 9: Credit Risk

Introduces various approaches to model credit risk, including structural and reduced-form models.
